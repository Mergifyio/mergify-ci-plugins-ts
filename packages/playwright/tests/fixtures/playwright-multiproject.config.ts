...
// reruns (scoped via `[project] > key` test-list lines — `>` is the single
// delimiter Playwright's loader accepts per line), and produces its own
// verdict row in the summary.
